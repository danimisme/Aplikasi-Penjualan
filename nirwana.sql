...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2023 at 05:20 PM
...
(2, 'Eriel', 'eriel', 'eriellelelelele', 'Staff Gudang', 'admin');
...
('TR0014', '2023-05-05', 'Pembelian BL0011', 0, 4000000);
...
CREATE TABLE `barang` (
  ...
  `hargaBeli` decimal(15,0) NOT NULL,
  `hargaJual` decimal(15,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `barang` (`IDBrg`, `namaBrg`, `jenis`, `merek`, `hargaBeli`, `hargaJual`) VALUES
('PC/G2020', 'PRINTER CANON G2020', 'Printer', 'CANON', '1870000', '2000000'),
('PE/L3210', 'PRINTER EPSON L3210', 'Printer', 'EPSON', '1980000', '2220000'),
('PE/L3250', 'PRINTER EPSON L3250', 'Printer', 'EPSON', '2530000', '2850000'),
('PE/L1300', 'PRINTER EPSON L1300', 'Printer', 'EPSON', '5650000', '5950000'),
('PE/L1800', 'PRINTER EPSON L1800', 'Printer', 'EPSON', '7600000', '8000000'),
('PC/G1020', 'PRINTER CANON G1020', 'Printer', 'CANON', '1330000', '1450000'),
('PH/HP315', 'PRINTER HP 315', 'Printer', 'HP', '1450000', '1650000'),
('PH/HP415', 'PRINTER HP 415', 'Printer', 'HP', '1980000', '2120000'),
('PB/T220', 'PRINTER BROTHER T220', 'Printer', 'BROTHER', '1880000', '2100000'),
('PB/T420', 'PRINTER BROTHER T420', 'Printer', 'BROTHER', '2120000', '2450000'),
('PB/T520W', 'ORINTER BROTHER T520W', 'Printer', 'BROTHER', '2450000', '2800000');
...
('BL0011', '2023-05-05', 'SP0002', '4000000');
...
INSERT INTO `retur` (`kode`, `tanggal`, `IDBrg`, `jumlahmasuk`, `jumlahkeluar`, `ket`) VALUES
('RT0001', '2023-03-20', 'PC/G1020', 1, 0, ''),
('RT0002', '2023-05-02', 'PE/L3210', 1, 0, ''),
('RT0003', '2023-06-06', 'PC/G1020', 1, 0, 'TES masuk'),
('RT0004', '2023-06-06', 'PC/G2020', 0, 1, 'tes keluar'),
('RT0005', '2023-06-06', 'PC/G2020', 1, 0, 'tes masuk'),
('RT0006', '2023-06-06', 'PC/G2020', 1, 0, 'retur barang'),
('RT0007', '2023-06-06', 'PC/G2020', 0, 1, 'Rusak');

--
-- Triggers `retur`
--
DELIMITER $$
CREATE TRIGGER `keluar` BEFORE INSERT ON `retur` FOR EACH ROW BEGIN
UPDATE stok SET Stok = stok - new.jumlahkeluar WHERE IDBrg = new.IDBrg;
END
$$
DELIMITER ;
DELIMITER $$
...
Stok = new.jumlahmasuk
ON DUPLICATE KEY UPDATE stok = Stok + new.jumlahmasuk;
...
('BL0011', 'PC/G2020', 'PRINTER CANON G2020', 2, '2000000', '4000000');
