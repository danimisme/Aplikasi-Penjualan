...
public class ListDataBarang extends javax.swing.JFrame {
    ...
    public ListDataBarang() {
        ...
        form = FormPembelian.form;
        if (form == null || form.equals("penjualan")) {
             form = FormPenjualan.form; 
            System.out.println("if 1");
        } else if(form.equals("penjualan")) {
    ...
    public void cariData(){
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "Select * from barang where IDBrg like '%" + txCari.getText() + "%'" +
    ...
    private void initComponents() {
        ...
        Judul2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/barang-icon.png"))); // NOI18N
        Judul2.setText(" Data Barang");
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        String id = (String) model.getValueAt(i, 0);
            ...
            Connection c = koneksi.getKoneksi();
            Statement s = c.createStatement();
            String sql = "SELECT * FROM barang WHERE IDBrg = '"+id+"' ";
            
            ResultSet r = s.executeQuery(sql);
            if(r.next()){
                
                
                if (form.equals("penjualan")){
                FormPenjualan.txIDBarang.setText(id);
                FormPenjualan.txNamaBarang.setText(r.getString("namaBrg"));
                FormPenjualan.txHarga.setText(r.getString("hargaJual"));
                FormPenjualan.txJumlah.requestFocus();;
                }
                else if (form.equals("pembelian")) {
                FormPembelian.txIDBarang.setText(id);
                FormPembelian.txNamaBarang.setText(r.getString("namaBrg"));
                FormPembelian.txHarga.setText(r.getString("hargaBeli"));
                FormPembelian.txJumlah.requestFocus();
                } else if (form.equals("retur")) {
                FormRetur.txIdBrg.setText(id);
                FormRetur.txNamaBrg.setText(r.getString("namaBrg"));
                }
