 ...
 * @author msubh
 */
public class ListDataCust extends javax.swing.JFrame {
    koneksi koneksi = new koneksi();
    private DefaultTableModel list;
    /**
     * Creates new form ListDataCust
     */
    public ListDataCust() {
        initComponents();
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        FormPenjualan.txIDCust.setText(id);
        FormPenjualan.txNamaCust.setText(nama);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListDataCust.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
