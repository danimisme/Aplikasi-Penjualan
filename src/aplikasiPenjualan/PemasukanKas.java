...
private DefaultTableModel model;
    ...
    public void loadData(){
        ...
        try {
            ...
            String sql = "SELECT * FROM aruskas where month(tanggal) = '"+bulan+"'and year(tanggal) = '"+tahun+ "' AND uangMasuk != '0' ORDER BY No";
            ResultSet r = s.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        PanelInput.add(btnTambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 170, -1, -1));
