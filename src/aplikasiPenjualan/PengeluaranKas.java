 ...
 * @author msubh
 */
public class PengeluaranKas extends javax.swing.JFrame {
    private DefaultTableModel model;
    /**
     * Creates new form PengeluaranKas
     */
    public PengeluaranKas() {
        initComponents();
    ...
    public void loadData(){
        ...
        try {
            ...
            String sql = "SELECT * FROM aruskas WHERE uangKeluar != '0' ORDER BY No ";
            ResultSet r = s.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        PanelInput.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pengeluaran Kas", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 1, 18))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PengeluaranKas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PengeluaranKas().setVisible(true);
            }
        });
    }
