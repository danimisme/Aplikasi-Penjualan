 ...
 * @author Dhani
 */
public class UpdateDataSupp extends javax.swing.JFrame {
public void autonumber(){
        try {
            Connection c = koneksi.getKoneksi();
            Statement s = c.createStatement();
            String IDSupp = "SP0001";
            boolean lanjut = true;
            do {
                String sql = "SELECT * FROM supplier WHERE IDSupp = '"+IDSupp+ "'" ;
                ResultSet r = s.executeQuery(sql);
                if (r.next()) {
                IDSupp = r.getString("IDSupp").substring(3);
                String CS = "" +(Integer.parseInt(IDSupp)+1);
                String Nol = "";
                if(CS.length()==1)
                {Nol = "000";}
                else if(CS.length()==2)
                ...
                lanjut = true ;
                    ...
                    lanjut = false;
                    txIDSupp.setText(IDSupp);
                    txNamaSupp.requestFocus();   
                    r.close();
                    s.close();
                }
            } while(lanjut);
    ...
    public void edit(){
        String id = txIDSupp.getText();
        String nama = txNamaSupp.getText();
        ...
        try {
            Connection c = koneksi.getKoneksi();
            String sql = "UPDATE supplier SET namaSupp = ?, alamat = ?, noTelp = ? WHERE IDSupp = ? ";
    ...
    /**
     * Creates new form UpdateDataSupp
     */
    public UpdateDataSupp() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txIDSupp.setEnabled(false);

        txNamaSupp.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        txNamaSupp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txNamaSuppActionPerformed(evt);
            }
        });
            ...
            .addGroup(PanelInputDataBarangLayout.createSequentialGroup()
                ...
                .addGroup(PanelInputDataBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(PanelInputDataBarangLayout.createSequentialGroup()
                        ...
                        .addGap(62, 62, 62)
                        .addComponent(txIDSupp, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(PanelInputDataBarangLayout.createSequentialGroup()
                        ...
                        .addGroup(PanelInputDataBarangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txNamaSupp, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txNamaSuppActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txNamaSuppActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txNamaSuppActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDataSupp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateDataSupp().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTextField txIDSupp;
    public javax.swing.JTextField txNamaSupp;
